...
{
    internal class NewtonConverter
    {
        public class Data
        {
        ...
        private class UnitConverter : Newtonsoft.Json.JsonConverter
        {
            ...
            {
                return typeof(NewtonConverter.IUnit).IsAssignableFrom(objectType);
            }
                                            ...
                                            Newtonsoft.Json.JsonSerializer serializer)
            {
                ...
                if (obj != null)
                {
                    ...
                    if (isSingleUnit)
                    {
                        return new NewtonConverter.House(name, isSingleUnit);
                    }
                    else
                    {
                        return new NewtonConverter.Apartment(name, isSingleUnit);
                    }
                }
                else
                {
